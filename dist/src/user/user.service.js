...
let UserService = UserService_1 = class UserService {
    ...
    async create(createUserDto) {
        ...
        console.log(...oo_oo(`1221590246_53_2_53_58_4`, "User's date of birth: ", createUserDto.dob));
        const dobDate = createUserDto.dob instanceof Date
            ? createUserDto.dob
            : new Date(createUserDto.dob);
        const eighteenYearsAgo = new Date();
        eighteenYearsAgo.setFullYear(eighteenYearsAgo.getFullYear() - 18);
        console.log(...oo_oo(`1221590246_65_2_65_64_4`, "Current date minus 18 years: ", eighteenYearsAgo));
        console.log(...oo_oo(`1221590246_66_2_66_38_4`, "Parsed DOB: ", dobDate));
    ...
    async deleteUser(username) {
        ...
        console.log(...oo_oo(`1221590246_149_2_149_19_4`, user));
        if (!user) {
            throw new response_dto_1.NotFoundResponse("User not found");
        }
        await this.userRepo.delete({ username });
        console.log(...oo_oo(`1221590246_154_2_154_19_4`, user));
    }
